...
<template>
  <main class="container col-10 col-md-7 mx-auto card my-5 py-5 shadow">
    ...
    <div class="card col-10 mx-auto my-3card col-10 mx-auto my-3 shadow row g-0row g-0">
      <div class="row g-0">
        <div class="col-1 d-flex flex-wrap justify-content-end align-items-center">
          <!-- SVG icon -->
        ...
        <div class="col-11">
          <div class="card-body">
            ...
            <h2 v-if="projectIdeas === 1" class="card-title m-0">{{ projectIdeas }} projektidé</h2>
            <h2 v-else class="card-title m-0">{{ projectIdeas }} projektidéer</h2>
          </div>
        </div>
      </div>
    </div>

    <!-- Card for started projects -->
    <div class="card col-10 mx-auto my-3card col-10 mx-auto my-3 shadow row g-0row g-0">
      <div class="row g-0">
        <div class="col-1 d-flex flex-wrap justify-content-end align-items-center">
          <!-- SVG icon -->
        ...
        <div class="col-11">
          <div class="card-body">
            <!-- Heading with if/else statement -->
            <h2 v-if="projectStarted === 1" class="card-title m-0">{{ projectStarted }} påbörjat projekt</h2>
            <h2 v-else class="card-title m-0">{{ projectStarted }} påbörjade projekt</h2>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card col-10 mx-auto my-3card col-10 mx-auto my-3 shadow row g-0row g-0">
      <div class="row g-0">
        ...
        <div class="col-11">
          <div class="card-body">
            <!-- Heading with if/else statement -->
            <h2 v-if="projectFinished === 1" class="card-title m-0">{{ projectFinished }} avslutat projekt</h2>
            <h2 v-else class="card-title m-0">{{ projectFinished }} avslutade projekt</h2>
          </div>
        </div>
      </div>
    </div>
